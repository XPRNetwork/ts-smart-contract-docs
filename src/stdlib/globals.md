...
In addition to using the generic builtins above, most WebAssembly instructions can be written directly in Proton code. For example, the following is equivalent:
