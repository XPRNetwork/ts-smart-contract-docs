...
Small, copy-pastable Proton examples using common syntax and patterns.

## Class

An Proton snippet on using Classes, their instantiation, and their static properties.
...
Extending classes and general Object Orientated Programming (OOP) in Proton
...
Handling Null as a union type for optional return values and simulating `try/catch` for errors in Proton
...
Using `switch case` statements in Proton.
...
Using Ternary if-else in Proton
