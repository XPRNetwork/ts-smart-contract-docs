---
description: A collection of general WebAssembly and Proton questions and their answers.
---
...
## Is Proton faster than JavaScript?
...
## Will Proton support all of TypeScript eventually?

It very likely won't. While TypeScript adds *some* static typing to JavaScript, its type system also tries to describe any possible dynamic feature of JavaScript. TypeScript is a superset of JavaScript after all. As such there is a point where it becomes infeasible to support JavaScript features that TypeScript can describe without adding an interpreter mode to Proton, which is a non-goal.

## How can I help?

There are various ways to help. Proton is an open source project, and everyone is welcome to contribute [code](https://github.com/Proton/proton), [documentation](https://github.com/Proton/website), or time. We also have an [OpenCollective](https://opencollective.com/proton) for those preferring to help the project out with a sponsorship.
