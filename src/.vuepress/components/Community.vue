<template>
  <div v-if="members.length > 0" class="community">
    <div class="list">
      <a v-for="member in members" href="https://discord.gg/proton" :title="member.username" :class="member.status" target="_blank" rel="noopener">
