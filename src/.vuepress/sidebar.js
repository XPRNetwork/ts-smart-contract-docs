...
function getExamplesSidebar() {
  return [
    ...
    },
    {
      ...
      children: [
        '/examples/arrays',
        ['https://github.com/Proton/examples/tree/main/i64', 'I64 as a (node) library'],
        ['https://github.com/Proton/examples/tree/main/sdk', 'Using the browser SDK'],
        ['https://github.com/Proton/examples/tree/main/transform', 'Using compiler transforms']
      ]
    },
    {
