...
Like many other blockchains, XPR Network has two chains, the testnet and the mainnet. As you can guess, testnet is a version of XPR Network where you can test things. Testnet is a fabulous playground, it allows you to perform the exact same operation as mainnet with a little less power but you will not notice it 🙂.
...
### XPR Network Mainnet chain id

```
384da888112027f0321850a169f737c33e53b388aad48b5adace4bab97f437e0
```

### XPR Network Testnet chain id
